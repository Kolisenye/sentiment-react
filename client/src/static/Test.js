            ...
            <div class="container mx-auto space-y-16">
              <section class="grid gap-6 text-center lg:grid-cols-2 xl:grid-cols-5">
                <div class="w-full p-6 rounded-md sm:p-16 xl:col-span-2 bg-coolGray-50">
                  <span class="block mb-2 text-indigo-600">
                    Mamba design system
                  </span>
                  <h1 class="text-5xl font-extrabold text-coolGray-900">
                    Build it with Mamba
                  </h1>
                  <p class="my-8">
                    <span class="font-medium text-coolGray-900">
                  ...
                  >
                    <div>
                      ...
                      <input
                        ...
                        class="w-full rounded-md focus:ring focus:ring-indigo-600 border-coolGray-300"
                      />
                    </div>
                    <div>
                    ...
                    <button class="w-full py-2 font-semibold rounded bg-indigo-600 text-coolGray-50">
                      Join the waitlist
                    </button>
                  </form>
                </div>
            ...
            <div class="container flex justify-between p-6 mx-auto lg:p-8 bg-coolGray-50">
              ...
              <div class="flex space-x-2">
                <a
                  aria-label="Email"
                  href="#"
                  class="flex items-center justify-center text-coolGray-600"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
